 ...
 */
#ifndef EWOMS_RESERVOIR_PROBLEM_DYNAMIC_HH
#define EWOMS_RESERVOIR_PROBLEM_DYNAMIC_HH
 ...
 */
template <class TypeTag>
class ReservoirProblemDynamic : public GetPropType<TypeTag, Properties::BaseProblem>
{
...
public:
     ...
     */
    ReservoirProblemDynamic(Simulator& simulator)
    ...
    void gridChanged()
    {
        ParentType::gridChanged();//is from fvbaseproblem.hh 304
        // tihs probably do to much but at least need to do update of the vtk writing
        auto gridView = this->simulator().vanguard().gridView();
